...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "test4", Version = "v1" });
...
builder.Services.AddTransient<test4Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "test4 API v1");
